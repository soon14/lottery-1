...
public class MapUtils {
     ...
     *
     * <strong>注意：</strong>
     * 由于对于一般的HashMap，元素的顺序并不是put的顺序，所以使用本函数得到的值并不是第一次put的值，如果想得到第一次put的值，请使用TreeMap
     *
     * @param <K>
     * @param <V>
     * @param map map
    ...
    /**
     * 遍历map ，把value==null 转换成 value == ""
     *
     * @param data
     * @return
     */
    public static Map<String, Object> getNotNullMap(Map<String, Object> data) {
        if (data == null) {
            return null;
        }
       ...
       public static Map<String, String> getNotNullMessageMap(Map<String, String> data) {
        if (data == null) {
            return null;
        }
    ...
    public static List<Map<String, Object>> getNotNullListMap(List<Map<String, Object>> data) {
        if (data == null) {
            return null;
        }
     ...
     * @return
     */
    public static Map<String, Object> toPhotoMap(Map<String, Object> map, String key, String showImgUrl) {
        if (map.containsKey(key)) {
            if (map.get(key) != null && !"".equals(map.get(key))) {
                map.put(key, showImgUrl + map.get(key));
            } else {
                map.put(key, showImgUrl + "/default.png");
            }
        }
        return map;
    }
