 ...
 * 国际化静态工具类.
 * <p>
 * 用于简化对{@link MessageSource}的调用. 解决每次在Controller中调用MessageSource必须注入
 * {@link MessageSource}的麻烦, 同时也可以提供给非HTTP请求或者不经过Controller的类（比如VO或工具类等）使用.
 * <p>
 * 
 * @author GuoLin
 *
...
public class MessageHolder {
	...
	if (messageSource instanceof CustomResourceBundleMessageSource) {
	    return ((CustomResourceBundleMessageSource) messageSource)
