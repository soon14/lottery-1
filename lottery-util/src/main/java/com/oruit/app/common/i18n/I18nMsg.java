 ...
 * 
 */
package com.oruit.app.common.i18n;
...
public class I18nMsg implements Serializable {
    ...
    // 由zhangjing注释。由于使用可变长参数，会与public I18nMsg(String key, Object... vars)
    // 的构造函数在调用时给开发者造成混淆。考虑其他的构造函数方法
    /*
     * public I18nMsg(String resourceBundleName, String key, Object... vars) {
     * this.resourceBundleName = resourceBundleName; this.key = key; this.vars =
     * vars; }
     */
    ...
    public static I18nMsg createMsg(List<I18nMsg> i18nMsgs, String key,
	    Object... varargs) {
	I18nMsg msg = new I18nMsg(key, varargs);
	i18nMsgs.add(msg);
	return msg;
