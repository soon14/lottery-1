...
import com.oruit.weixin.bean.FollowResult;
import com.oruit.weixin.bean.Group;
import com.oruit.weixin.bean.User;
import com.oruit.weixin.bean.UserInfoList;
...
public class UserAPI extends BaseAPI{
	...
	public static BaseResult groupsMembersBatchUpdate(String access_token,List<String> openid_list,String to_groupid){
		String openidListStr = JsonDealUtil.toJSONString(openid_list);
