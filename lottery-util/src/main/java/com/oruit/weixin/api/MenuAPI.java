...
import com.oruit.weixin.bean.Menu;
import com.oruit.weixin.bean.MenuButtons;
import com.oruit.weixin.bean.selfmenu.CurrentSelfmenuInfo;
...
public class MenuAPI extends BaseAPI{
	...
	public static BaseResult menuCreate(String access_token,MenuButtons menuButtons){
		String str = JsonDealUtil.toJSONString(menuButtons);
