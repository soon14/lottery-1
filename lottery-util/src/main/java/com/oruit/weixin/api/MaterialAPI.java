...
import com.oruit.weixin.bean.MediaType;
import com.oruit.weixin.bean.material.Description;
import com.oruit.weixin.bean.material.MaterialBatchgetResult;
import com.oruit.weixin.bean.material.MaterialcountResult;
import com.oruit.weixin.bean.material.NewsItem;
...
public class MaterialAPI extends BaseAPI{
	...
	public static Media materialAdd_material(String access_token,MediaType mediaType,File media,Description description){
		...
		MultipartEntityBuilder multipartEntityBuilder = MultipartEntityBuilder.create()
        		 			.addPart("media", bin);
        if(description != null){
        	multipartEntityBuilder.addTextBody("description", JsonDealUtil.toJSONString(description));
        }
